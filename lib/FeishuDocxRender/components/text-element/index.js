...
var text_element_default = (0, import_react.memo)(({
  ...
  const tsx = data ? /* @__PURE__ */ import_react.default.createElement(
    ...
    !!(data == null ? void 0 : data.text_run) && /* @__PURE__ */ import_react.default.createElement(import_text_run.default, { data: data == null ? void 0 : data.text_run, render, onLink }),
    !!(data == null ? void 0 : data.equation) && /* @__PURE__ */ import_react.default.createElement(import_latex.default, { data: data == null ? void 0 : data.equation, render, onLink })
  ) : null;
