...
var getCalloutStyle = (d) => {
  var _a, _b, _c, _d;
  const obj = [];
  obj.push(`feishudocx-calloutstyle-bgcolor-${((_a = d.callout) == null ? void 0 : _a.background_color) || 2}`);
  obj.push(`feishudocx-calloutstyle-bdcolor-${((_b = d.callout) == null ? void 0 : _b.border_color) || 2}`);
